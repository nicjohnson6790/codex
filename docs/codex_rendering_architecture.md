...
The user visually accepted the probe lighting and corrected direct-sun balance. Generated build-folder logs were cleaned up after acceptance; the validation results below are retained as the record. GPU timing and future foliage integration remain outstanding.
